...
To accomplish this, it has been necessary to provide to DWA all the information it normally expects on certain topics such as
\texttt{/odom}, \texttt{/goal}, and\texttt{/map}.\\
...
\begin{lstlisting}
    source \sim/ROS_trajectory_tracking_controller/devel/setup.bash
\end{lstlisting}
...
(aggiungi fase di installazione: menziona pacchetti)
